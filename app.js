...
const getImages = (query) => {
  ...
  fetch(
    ...
    .then((data) => showImages(data.hits))                               // Problem - 01 //
    .catch((err) => console.log(err));
};



// --Image Select and Un-Select --//                                  // Problem -05  //
let slideIndex = 0;
...
var input = document.getElementById("search");                   // Problem -04 //
